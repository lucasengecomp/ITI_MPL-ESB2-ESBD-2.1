import unittest
from Roman_samples07 import RomanSamples
...
class RomanToIntTest(unittest.TestCase):
    ...
    def test_roman14(self):
        self.assertEqual(RomanSamples.RomanToInt("XIV"), 14)

    def test_roman15(self):
        self.assertEqual(RomanSamples.RomanToInt("IVVVI"), 15)